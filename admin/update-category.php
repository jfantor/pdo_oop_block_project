    ...
    <div class="container">
      <div class="row">
        ...
        <?php
          ...
          $obj->select("category","*",null,"category_id ='{$cat_id}'");
        ...
        <?php
          if(isset($_POST['submit'])){
            ...
            $obj->select("category","category_name",null,"category_name='{$category}' AND NOT category_id='{$cat_id}'");
            ...
            if (COUNT($result1)> 0) {
              ...
              $value = ["category_id"=>$_POST['cat_id'],"category_name"=>$_POST['cat_name']];
              

            //   $sql1 = "UPDATE category SET category_id='{$_POST['cat_id']}', category_name='{$_POST['cat_name']}'  WHERE  category_id={$_POST['cat_id']}";

              if ($obj->update('category',$value,"category_id={$_POST['cat_id']}")){
